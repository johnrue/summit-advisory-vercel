...
1. **Successful hybrid architecture deployment with zero errors**:
   ...
   - Marketing site remains operational on Amplify (summitadvisoryfirm.com)
   ...
   - Repository separation completed with proper CI/CD for each deployment target
...
- [ ] Task 1: Hybrid Architecture Repository Separation (AC: 1) 📋 **PLANNED**
  - [ ] Create new Git repository for SaaS platform (app.summitadvisoryfirm.com)
  - [ ] Migrate Guard Management Platform code from current directory to new repo
  - [ ] Update existing Amplify repository with portal links and fallback pages
  - [ ] Configure separate CI/CD pipelines: GitHub Actions for EC2, Amplify auto-deployment
  - [ ] Test repository isolation and cross-domain integration

- [ ] Task 2: AWS Infrastructure Deployment Setup (AC: 1) ✅ **READY**
  - [ ] Use AWS MCP to deploy cost-optimized EC2/ALB infrastructure (t3.micro/small instances)
  - [ ] Configure SSL certificate for app.summitadvisoryfirm.com using AWS Certificate Manager
  - [ ] Set up AWS Secrets Manager for secure environment variable management
  - [ ] Configure Route53 DNS routing for hybrid architecture
  - [ ] Set up billing alerts ($50, $100, $200) and CloudWatch cost monitoring
  - [ ] Deploy SaaS platform to EC2 with security groups and VPC using AWS MCP
  - [ ] Test automated deployment pipeline from GitHub to EC2
...
- [ ] Task 7: Security and Compliance Validation (AC: 1, 2) ✅ **READY**
...
```plaintext
# Repository #1: Marketing Site (Existing Amplify)
summit-advisory-amplify/
├── pages/                    # Marketing pages with portal links
├── components/               # Marketing components
└── public/                   # Static assets

# Repository #2: SaaS Platform (Current Directory → New Repo)
summit-saas-platform/
├── .github/workflows/        # EC2 deployment pipeline
