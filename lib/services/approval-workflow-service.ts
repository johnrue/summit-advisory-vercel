...
export class ApprovalWorkflowService {
  ...
  async submitApprovalDecision(
    ...
    try {
      ...
      if (!authorityCheck.success) {
        return { success: false, error: { code: 'INSUFFICIENT_AUTHORITY', message: 'Insufficient approval authority' } }
      }
  ...
  async submitRejectionDecision(
    ...
    try {
      ...
      if (!authorityCheck.success) {
        return { success: false, error: { code: 'INSUFFICIENT_AUTHORITY', message: 'Insufficient rejection authority' } }
      }
